...
void TriggerZone::setup(Vector3 position, Vector3 size)
{
	...
	rigidbody = &Physics::CreateRigidbodyComponent(new RigidbodyComponent(new BoxAABBColComp(Box{ Vector3::zero, size * 0.5f }, this, false, "trigger_zone", false, false), false, true));
